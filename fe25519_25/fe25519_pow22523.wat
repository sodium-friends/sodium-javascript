(module  
  ...
  (func $fe25519_pow22523 (export "fe25519_pow22523") (param $out i32) (param $f i32)
    (local $f0 i64)
    (local $f1 i64)
    (local $f2 i64)
    (local $f3 i64)
    ...
    (local $t0_0 i64) (local $t1_0 i64)
    (local $t0_1 i64) (local $t1_1 i64)
    (local $t0_2 i64) (local $t1_2 i64)
    (local $t0_3 i64) (local $t1_3 i64)
    (local $t0_4 i64) (local $t1_4 i64)
    (local $t0_5 i64) (local $t1_5 i64)
    (local $t0_6 i64) (local $t1_6 i64)
    (local $t0_7 i64) (local $t1_7 i64)
    (local $t0_8 i64) (local $t1_8 i64)
    (local $t0_9 i64) (local $t1_9 i64)
